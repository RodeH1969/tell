...
FILES = [
    "Adam Smith.png","Ben Shapiro.png","Benjamin Franklin.png","Bing Crosby.png","Bobby Charlton.png",
    "Charlie Chaplin.png","Connor McGregor.png","Edmund Hilary.jpg","Ernest Hemingway.png","George Orwell.png",
    "George Washington.png","Henry Ford.png","Humphrey Bogart.png","James Cook.png","JD Salinger.jpg",
    "John Newcombe.png","Johnny Carson.png","Keith Miller.jpeg","Laurence Olivier.png","Liberace.jpg",
    "Mark Twain.png","Marlon Brando.png","Micahel Caine.png","Mozart.png","Napoleon Bonaparte.png",
    "Nigel Farage.png","Nikola Tesla.png","Paul Newman.png","Pele.png","Pete Hegseth.png",
    "Pierre Trudeau.jpg","Randy Orton.png","Richard Burton.png","Richie Mccaw.png","Robert Kennedy Jnr.png",
    "Sigmund Freud.png","Thomas Jefferson.png","Tucker Carlson.png","Voltaire.png","Winston Churchill.png"
]
